<template>
  <div class="about">
    <h1 class="title animate__animated animate__bounceInLeft">Account Settings</h1>
    <h2 class="subtitle">Here you can view your profile and update!
      Click on the edit icon to update!
    </h2>
